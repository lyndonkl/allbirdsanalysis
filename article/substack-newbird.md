...
About $89M of new capital, on top of roughly $39M of existing Q1 cash, for a nominal **$128M total capital base** — of which **$50M is the convertible note, which is a loan, not equity**. The new-capital pieces are the $39M from the footwear sale to American Exchange (some of which is earmarked for a special dividend, an interesting choice for a company that just told the market it needs capital) and $50M from the convertible if and when shareholders approve it. The realistically deployable share for actually building an AI compute business — net of fees, the special dividend, public-company overhead, the residual cash burn of a footwear wind-down, the inevitable severance to the people whose job was, until recently, sneakers, and the fact that the $50M convertible has to be repaid or converted — is something like $50–70M.
...
> **[CHART 3 — "NewBird's $128M capital base — half of it debt — is 0.4% of what it takes to compete"]**
> *Horizontal log-scale bar chart. Six rows: Hyperscaler combined ($600B), CoreWeave 2026 capex ($14.9B), Applied Digital ($7B), Lambda Labs ($2.3B), minimum-viable-neocloud band ($500M–$1B, dashed outline), NewBird AI ($128M, in bear-red `#B23A48`, composed of $39M cash + $39M asset sale + $50M convertible debt). All competitor bars in muted grey-context (`#8A8A8A`). Direct label on NewBird bar: "$128M total capital base — $50M of it is convertible debt, not equity." Footnote: "Log scale: each gridline = 10×". 700×525px (4:3). Built in Observable Plot (`barX` with `xScale: { type: "log" }`). Time-to-insight: 5 seconds.*

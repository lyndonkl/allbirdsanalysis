...
The filing discloses what the press release did not: alongside a fixed-price conversion path, the convertible carries an alternate floating-price conversion mechanic that references a discount to a post-issuance measurement period. Which mechanic controls at maturity — and on what trigger — is the trade. If the fixed path prevails, NewBird AI is a real corporate entity with a real (if speculative) chance of being a real business. If the floating alternate activates, existing shareholders are the funding source for a financing whose terms they will discover gradually over the next twelve to twenty-four months as they are diluted into single-digit ownership of a company they used to own.

Both mechanics were disclosed on April 15. Which one runs the outcome is not. This is not a retail trade today; it is a reading assignment.
...
The [math, holding the convertible at $50M](https://github.com/lyndonkl/allbirdsanalysis/blob/main/reports/v2/04-special-situations-distressed.md):
...
A reasonable investor cannot have a confident view on NewBird AI before the definitive proxy lands, because the definitive filing is where the exhibits get nailed down and the floating mechanic's triggers get specified in full. This is unsatisfying. It is also true.
...
The single piece of paper that resolves this trade is on EDGAR, in preliminary form, with the key exhibit describing a floating-price alternate. Until the definitive filing lands and the final triggers are visible, this is not a story about an AI company. It is a story about whether a small company in Portland is about to be financially eaten by an undisclosed institutional investor wearing the costume of a strategic partner.
